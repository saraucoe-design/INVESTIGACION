...
def main() -> None:
    ...
    with mlflow.start_run():
        ...
        metrics = {
            "artifact_status": "reproducibility_proof_of_concept",
            "data_status": "synthetic_demonstration_microdata",
            "interpretation": "demo_metrics_not_empirical_findings",
    ...
    print("WARNING: Reproducibility proof-of-concept using synthetic microdata. Metrics are NOT empirical findings.")
